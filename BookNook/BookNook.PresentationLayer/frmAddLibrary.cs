...
{
    public partial class frmAddLibrary : Form, IAddNewLibraryBookView
    {
        ...
        public DateTime DateBorrowed => dateBorrowedPicker.Value;
        public DateTime DueDate => dateDuePicker.Value;
        public string Library => libraryInput.Text;
